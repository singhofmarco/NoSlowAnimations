...
@property(readonly, nonatomic) int widgetIdiom; // @synthesize widgetIdiom=_widgetIdiom;
...
- (void)_requestPresentationOfViewController:(id)arg1 presentationStyle:(int)arg2 context:(id)arg3 completion:(id)arg4;
